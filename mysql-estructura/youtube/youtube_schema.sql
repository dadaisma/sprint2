...
CREATE TABLE IF NOT EXISTS `youtube`.`video` (
  ...
  INDEX `fk_video_playlist1_idx` (`id_playlist` ASC) VISIBLE,
  INDEX `fk_video_canal1_idx` (`id_canal` ASC) VISIBLE,
  INDEX `fk_video_usuario1_idx` (`id_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `youtube`.`tag` (
  ...
  PRIMARY KEY (`id_tag`),
  INDEX `fk_tag_video1_idx` (`id_video` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `youtube`.`comentario` (
  ...
  INDEX `fk_comentario_video1_idx` (`id_video` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `youtube`.`like` (
  ...
  `id_usuario` INT NOT NULL,
  PRIMARY KEY (`id_like`),
  INDEX `fk_like_video1_idx` (`id_video` ASC) VISIBLE,
  INDEX `fk_like_comentario1_idx` (`id_comentario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `youtube`.`dislike` (
  ...
  INDEX `fk_dislike_video_idx` (`id_video` ASC) VISIBLE,
  INDEX `fk_dislike_comentario1_idx` (`id_comentario` ASC) VISIBLE,
  INDEX `fk_dislike_usuario1_idx` (`id_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `youtube`.`subscription` (
  ...
  INDEX `fk_subscription_usuario1_idx` (`id_usuario` ASC) VISIBLE,
  INDEX `fk_subscription_canal1_idx` (`canal_id_canal` ASC) VISIBLE,
